...
def main():
    ...
    wandb.init(project="CaffeNetValLoss_" + args.test_domain[0], config=args)
    ...
    model_name = 'caffenet_val_loss_seed_' + str(config.seed) + '_test_domain_' + config.test_domain[0]
