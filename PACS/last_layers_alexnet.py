...
def main():
    ...
    wandb.init(project="CaffeNetFreezeValLoss_" + args.test_domain[0], config=args)
    ...
    model_name = 'caffenetfreeze_val_loss_seed_' + str(config.seed) + '_test_domain_' + config.test_domain[0]
    ...
    train_loader = data_utils.DataLoader(
        PacsData('./kfold/', domain_list=train_domain, mode='train'),
