...
def main():
    ...
    wandb.init(project="CaffeNetFreezeValLossRandomGrey_" + args.test_domain[0], config=args)
    ...
    model_name = 'caffenetfreeze_val_loss_random_grey_seed_' + str(config.seed) + '_test_domain_' + config.test_domain[0]
