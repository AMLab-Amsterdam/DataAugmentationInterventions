...
from paper_experiments.PACS.pacs_data_loader_grey import PacsDataGrey
...
def main():
    ...
    wandb.init(project="CaffeNetGrey_" + args.test_domain[0], config=args)
    ...
    model_name = 'caffenet_grey_seed_' + str(config.seed) + '_test_domain_' + config.test_domain[0]
    ...
    train_loader = data_utils.DataLoader(
        PacsDataGrey('./kfold/', domain_list=train_domain, mode='train'),
        batch_size=config.batch_size,
        shuffle=True, **kwargs)
    val_loader = data_utils.DataLoader(
        PacsDataGrey('./kfold/', domain_list=train_domain, mode='val'),
        batch_size=config.batch_size,
    ...
    test_loader = data_utils.DataLoader(
        PacsDataGrey('./kfold/', domain_list=config.test_domain, mode='test'),
        batch_size=config.batch_size,
        shuffle=False, **kwargs)
