...
from paper_experiments.rotated_MNIST.mnist_loader_shifted_label_distribution_all_da import MnistAllDaDist
...
def main():
    ...
    mnist_30 = MnistAllDaDist('../dataset/', train=True, thetas=[30.0], d_label=0)
    mnist_0 = MnistAllDaDist('../dataset/', train=True, thetas=[0.0], d_label=1)
    mnist_90 = MnistAllDaDist('../dataset/', train=True, thetas=[90.0], d_label=2)
    model_name = 'baseline_test_60_all_da_seed_' + str(args.seed)

    mnist = data_utils.ConcatDataset([mnist_30, mnist_0, mnist_90])
    ...
    # Test loader
    mnist_60 = MnistRotated('../dataset/', train=False, thetas=[60.0], d_label=0)
