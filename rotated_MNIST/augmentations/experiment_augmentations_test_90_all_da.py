...
def main():
    ...
    mnist_60 = MnistAllDaDist('../dataset/', train=True, thetas=[60.0], d_label=1)
    mnist_0 = MnistAllDaDist('../dataset/', train=True, thetas=[0.0], d_label=2)
    model_name = 'baseline_test_90_all_da_seed_' + str(args.seed)

    mnist = data_utils.ConcatDataset([mnist_30, mnist_60, mnist_0])
    ...
    test_loader = data_utils.DataLoader(mnist_90,
                                        batch_size=args.batch_size,
                                        shuffle=False, **kwargs)
